...
public enum Mixins {
    ...
    ANGELICA(new Builder("Angelica").addTargetedMod(TargetedMod.VANILLA).setSide(Side.CLIENT)
        .setPhase(Phase.EARLY).addMixinClasses(
            ...
            ,"angelica.bugfixes.MixinChunk"
            ,"angelica.bugfixes.MixinChunkProviderServer"
            ,"angelica.bugfixes.MixinClientRegistry"
            ,"angelica.bugfixes.MixinForgeHooksClient"
            ...
            ,"angelica.optimizations.MixinEntityItem_RenderDist"
            ,"angelica.optimizations.MixinFrustrum"
            ,"angelica.optimizations.MixinLongHashMap"
            ,"angelica.optimizations.MixinRendererLivingEntity"
            ,"angelica.optimizations.MixinTileEntityMobSpawner"
